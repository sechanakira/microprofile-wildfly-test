...
This will create an executable jar file **microprofile-wildfly-test-wildfly.jar** within the _target_ maven folder. This can be started by executing the following command

    java -jar target/microprofile-wildfly-test-wildfly.jar -Djboss.socket.binding.port-offset=100
